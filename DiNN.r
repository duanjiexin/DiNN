...
for(i_rep in 1:rep_sim){
  ...
  time_1_m = Sys.time()
  time_m = time_1_m - time_0_m
  time_m = round(as.numeric(time_m, units="secs"),digits=2) # display 2 digits by unit secs
  time_m = time_divide_m + time_m 
  ...
  time_1_w = Sys.time()
  time_w = time_1_w - time_0_w
  time_w = round(as.numeric(time_w, units="secs"),digits=2) # display 2 digits by unit secs
  time_w = time_divide_w + time_w 
